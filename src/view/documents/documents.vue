  ...
  <div>
    <div class="log_box">
      <div class="log_user_capital">
        <div class="table_name">按钮(el-button)</div>
        <div>
      ...
      <div class="log_user_capital">
        <div class="table_name">图标</div>
        <div v-for="(item,index) in iconList" class="item_box">
          <i :class="item" style="width: 50px;height: 50px;font-size: 24px"></i>
          <span>{{item}}</span>
        </div>
      </div>
    </div>
